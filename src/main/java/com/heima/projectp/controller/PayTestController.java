...
import com.heima.projectp.pojo.CallbackBean;
...
public class PayTestController {
    ...
    @Autowired
    PayBase payBase;
    String domainAddr = "8a0f-154-18-168-67.ngrok-free.app"; //ngrok 臨時域名
...
//        map.put("statusQ","1");
    ...
    private static StringBuffer dealRequest(String callBackUrl, CallbackBean bean) throws IOException {
        ...
        System.out.println("回調請求參數 : " + s);

        out.writeBytes(s); // 回調數據
        out.flush();
        out.close();
